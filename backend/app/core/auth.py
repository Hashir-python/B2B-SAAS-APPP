...
class AuthUser:
    ...
    def can_view(self)->bool:
        return self.has_permission("org:task:view")
    
    @property
    def can_create(self)->bool:
        return self.has_permission("org:task:create")
    
    @property
    def can_delete(self)->bool:
        return self.has_permission("org:task:delete")
    
    @property
    def can_edit(self)->bool:
        return self.has_permission("org:task:edit")
...
async def get_current_user(request: Request) -> AuthUser:
    ...
    if not org_id:
        raise HTTPException(status_code=status.HTTP_400_BAD_REQUEST, detail="Organization ID missing in token")
